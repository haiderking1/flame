import { DynamicBorder, type ExtensionAPI, type ExtensionContext } from "@earendil-works/flame-coding-agent";
import { Container, Text } from "@earendil-works/flame-tui";
