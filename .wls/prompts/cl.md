...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/earendil-works/flame-mono/issues/123))`
- External: `Added bar ([#456](https://github.com/earendil-works/flame-mono/pull/456) by [@user](https://github.com/user))`
