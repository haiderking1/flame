...
All keyboard shortcuts can be customized via `~/.flame/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.flame/agent/keybindings.json`:
