...
Sessions are saved automatically to `~/.flame/agent/sessions/`, organized by working directory.
...
- `~/.flame/agent/AGENTS.md` for global instructions
...
- `.flame/SYSTEM.md` for a project
- `~/.flame/agent/SYSTEM.md` globally
...
|----------|-------------|
| `FLAME_CODING_AGENT_DIR` | Override config directory; default is `~/.flame/agent` |
| `PI_CODING_AGENT_SESSION_DIR` | Override session storage directory; overridden by `--session-dir` |
| `FLAME_PACKAGE_DIR` | Override package directory, useful for Nix/Guix store paths |
