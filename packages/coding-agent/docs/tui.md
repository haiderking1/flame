...
**Source:** [`@earendil-works/flame-tui`](https://github.com/earendil-works/flame-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@earendil-works/flame-tui";
...
```typescript
import { Container, type Focusable, Input } from "@earendil-works/flame-tui";
...
Import from `@earendil-works/flame-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@earendil-works/flame-tui";
```
...
```typescript
import { matchesKey, Key } from "@earendil-works/flame-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@earendil-works/flame-tui";
...
```typescript
import { getMarkdownTheme } from "@earendil-works/flame-coding-agent";
import { Markdown } from "@earendil-works/flame-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@earendil-works/flame-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@earendil-works/flame-coding-agent";
import { DynamicBorder } from "@earendil-works/flame-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@earendil-works/flame-tui";
...
```typescript
import { BorderedLoader } from "@earendil-works/flame-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@earendil-works/flame-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@earendil-works/flame-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@earendil-works/flame-tui";
...
import { matchesKey, truncateToWidth } from "@earendil-works/flame-tui";
