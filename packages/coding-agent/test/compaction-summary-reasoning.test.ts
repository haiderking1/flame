...
import type { AssistantMessage, Model } from "@earendil-works/flame-ai";
...
vi.mock("@earendil-works/flame-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@earendil-works/flame-ai")>();
	return {
		...actual,
