...
import { Agent } from "@earendil-works/flame-agent-core";
import { getModel, type OAuthCredentials, type OAuthProvider } from "@earendil-works/flame-ai";
...
// ============================================================================
// OAuth API key resolution from ~/.flame/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".flame", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.flame/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.flame/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".flame", "agent");

/**
 * Get an AuthStorage instance backed by ~/.flame/agent/auth.json
