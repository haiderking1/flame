...
/**
 * Regression test for https://github.com/earendil-works/flame-mono/issues/2791
 *
...
process.env.FLAME_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync(process.execPath, [scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, FLAME_CODING_AGENT_DIR: agentDir },
