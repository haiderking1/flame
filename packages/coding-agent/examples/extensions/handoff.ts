...
import { complete, type Message } from "@earendil-works/flame-ai";
import type { ExtensionAPI, SessionEntry } from "@earendil-works/flame-coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@earendil-works/flame-coding-agent";
