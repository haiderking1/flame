import { type AgentMessage, uuidv7 } from "@earendil-works/flame-agent-core";
 ...
 * Encodes cwd into a safe directory name under ~/.flame/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.flame/agent/sessions/<encoded-cwd>/).
	 */
