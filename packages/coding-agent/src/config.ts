...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/earendil-works/flame-mono/releases/latest`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.FLAME_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json flameConfig)
// =============================================================================
...
const flameConfigName: string | undefined = pkg.flameConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@earendil-works/flame-coding-agent";
export const APP_NAME: string = flameConfigName || "flame";
export const APP_TITLE: string = flameConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.flameConfig?.configDir || ".flame";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., FLAME_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.FLAME_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.flame/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.flame/agent/) */
