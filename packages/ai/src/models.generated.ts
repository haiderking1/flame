...
export const MODELS = {
	...
	"ollama": {
		...
		"qwen3-next:80b": {
			id: "qwen3-next:80b",
			name: "Qwen3 Next 80b (Ollama Cloud)",
			api: "openai-completions",
			provider: "ollama",
			baseUrl: "https://ollama.com/v1",
			reasoning: true,
		...
		"qwen3-vl:235b": {
			id: "qwen3-vl:235b",
			name: "Qwen3 Vl 235b (Ollama Cloud)",
			api: "openai-completions",
			provider: "ollama",
			baseUrl: "https://ollama.com/v1",
			reasoning: true,
		...
		"qwen3-vl:235b-instruct": {
			...
			name: "Qwen3 Vl 235b-instruct (Ollama Cloud)",
			api: "openai-completions",
			provider: "ollama",
			baseUrl: "https://ollama.com/v1",
			reasoning: false,
