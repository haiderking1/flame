...
const CALLBACK_HOST = process.env.FLAME_OAUTH_CALLBACK_HOST || "127.0.0.1";
 ...
 * @param options.originator - OAuth originator parameter (defaults to "flame")
 */
