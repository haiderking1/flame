...
```bash
npm install @earendil-works/flame-ai
```

TypeBox exports are re-exported from `@earendil-works/flame-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@earendil-works/flame-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@earendil-works/flame-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@earendil-works/flame-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@earendil-works/flame-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@earendil-works/flame-ai';
...
```typescript
import { getModel, stream } from '@earendil-works/flame-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@earendil-works/flame-ai';
...
```typescript
import { Model, stream } from '@earendil-works/flame-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@earendil-works/flame-ai';
...
```typescript
import { getModel, complete, Context } from '@earendil-works/flame-ai';
...
```typescript
import { Context, getModel, complete } from '@earendil-works/flame-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@earendil-works/flame-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@earendil-works/flame-ai';
...
```bash
npx @earendil-works/flame-ai login              # interactive provider selection
npx @earendil-works/flame-ai login anthropic    # login to specific provider
npx @earendil-works/flame-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@earendil-works/flame-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@earendil-works/flame-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@earendil-works/flame-ai/oauth';
...
```typescript
import { getModel, complete } from '@earendil-works/flame-ai';
import { getOAuthApiKey } from '@earendil-works/flame-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@earendil-works/flame-ai`
